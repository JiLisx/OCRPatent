...
def process_pdf_folder(folder_path, output_folder, input_pdf_list,num_processes=10):
    ...
    finish_file = os.path.join(output_folder, "finish_reocr_error.txt")
    failed_file = os.path.join(output_folder, "failed_reocr_error.txt")
    json_file = os.path.join(output_folder, "frontpage_reocr_error.json")
